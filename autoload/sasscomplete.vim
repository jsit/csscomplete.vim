...
function! sasscomplete#CompleteSass(findstart, base)
  ...
  elseif borders[max(keys(borders))] == 'colon'
    ...
    if exists('g:sasscomplete_postfix')
      let postfix = g:sasscomplete_postfix
    endif

    if exists('b:sasscomplete_postfix')
      let postfix = b:sasscomplete_postfix
    endif
    ...
    elseif prop == 'overflow-anchor'
      let values = ["auto", "none"]
    elseif prop == 'overflow-wrap'
      let values = ["normal", "break-word"]
    elseif prop =~ '^overflow\%(-x\|-y\)\='
      let values = ["visible", "hidden", "scroll", "auto"]
    elseif prop =~ '^overscroll-behavior\%(-x\|-y\)\='
      let values = ["contain", "none", "auto"]
    elseif prop == 'pad'
      let values = []
    elseif prop == 'padding'
    ...
    elseif prop == 'text-decoration-skip'
      let values = ["none", "objects", "spaces", "leading-spaces", "trailing-spaces", "edges", "box-decoration"]
    elseif prop == 'text-decoration-skip-ink'
      let values = ["auto", "none"]
